...
public class FFmpegCommandUtil {
    private static final String TAG = "FFmpegCommandUtil";
    ...
    public static String[] audioEqualizer(String inputPath, List<String> bandList, String outputPath) {
        ...
        equalizerCmd = String.format(Locale.getDefault(), equalizerCmd, inputPath, builder, outputPath);
...
//        String transformVideoCmd = "ffmpeg -i %s -r 25 -b 200 -s 1080x720 %s";
    ...
    public static String[] transformVideoWithEncode(String inputPath, String outputPath) {
        Log.e(TAG, "transformVideoWithEncode: inputPath: " + inputPath);
        Log.e(TAG, "transformVideoWithEncode: outputPath: " + outputPath);
    ...
    public static String[] transformVideoWithEncode(String inputPath, int width, int height, String outputPath) {
        Log.i(TAG, "transformVideoWithEncode: inputPath : " + inputPath);
        Log.i(TAG, "transformVideoWithEncode: outputPath : " + outputPath);
        Log.i(TAG, "transformVideoWithEncode: width : " + width + "  height: " + height);
...
//            transformVideoCmd = "ffmpeg -i %s -codec copy -bsf h264_mp4toannexb " + "%s";
            // ffmpeg -i 1.mp4 -vcodec copy -acodec copy -vbsf h264_mp4toannexb 1.ts
            transformVideoCmd = "ffmpeg -i %s -vcodec copy -acodec copy -vbsf h264_mp4toannexb " + "%s";
        }
        transformVideoCmd = String.format(transformVideoCmd, inputPath, outputPath);
        Log.i(TAG, "transformVideoWithEncode: transformVideoCmd: " + transformVideoCmd);
        return transformVideoCmd.split(" ");
    }
    ...
    public static String[] jointVideo(String fileListPath, String outputPath) {
        Log.e(TAG, "jointVideo: fileListPath " + fileListPath + "  outputPath: " + outputPath);
//        String jointVideoCmd = "ffmpeg -f concat -safe 0 -i %s -c copy %s";
     ...
     */
    public static String[] cutVideo(String inputPath, String outputPath, int startTime, int duration) {
        ...
        Log.e(TAG, "inputPath:" + inputPath + " startTime: " + startTime + "  duratuion: " + duration + "   outputPath: " + outputPath);
    ...
    @Nullable
    public static String[] videoCompress(@NotNull String videoFilePath, @NotNull String videoResultPath) {
        String compresscmd = "ffmpeg -i %s -r 20 %s";
//        String transformVideoCmd = "ffmpeg -i %s -r 25 -b 200 -s 1080x720 %s";
        // assign the encoder
//        ffmpeg -i input.mp4 -vcodec libx264 -crf 20 output.mp4
        compresscmd = String.format(Locale.getDefault(), compresscmd, videoFilePath, videoResultPath);
        Log.i(TAG, "videoCompress: compresscmd: " + compresscmd);
        return compresscmd.split(" ");
    }
    ...
    public static String[] addWaterMarkGif(String inputPath, String imgPath, int location, int bitRate,
                                           int offsetXY, String outputPath) {
        String mBitRate = bitRate + "k";
        int offset = ViomiScreenUtil.dp2px(Utils.getApp(), offsetXY);
    ...
    public static String[] probeFormat(String inputPath) {
        Log.i(TAG, "probeFormat: inputPath:" + inputPath);
        ...
        Log.i(TAG, "probeFormat:ffprobeCmd:  " + ffprobeCmd);

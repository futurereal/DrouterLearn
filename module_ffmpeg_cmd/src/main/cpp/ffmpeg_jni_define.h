...
extern "C" { \
    JNIEXPORT RETURN_TYPE JNICALL java_com_viomi_ffmpeg_cmd_tool_AudioPlayer_ ## FUNC_NAME \
...
#define FFMPEG_FUNC(RETURN_TYPE, FUNC_NAME, ...) \
    JNIEXPORT RETURN_TYPE JNICALL Java_com_viomi_ffmpeg_cmd_tool_FFmpegCmdNative_ ## FUNC_NAME \
...
#define VIDEO_PLAYER_FUNC(RETURN_TYPE, FUNC_NAME, ...) \
    JNIEXPORT RETURN_TYPE JNICALL java_com_viomi_ffmpeg_cmd_tool_VideoPlayer_ ## FUNC_NAME \
    (JNIEnv *env, jobject thiz, ##__VA_ARGS__)\

#define MEDIA_PLAYER_FUNC(RETURN_TYPE, FUNC_NAME, ...) \
extern "C" { \
    JNIEXPORT RETURN_TYPE JNICALL java_com_viomi_ffmpeg_cmd_tool_MediaPlayer_ ## FUNC_NAME \
    (JNIEnv *env, jobject thiz, ##__VA_ARGS__);\
}\
    JNIEXPORT RETURN_TYPE JNICALL java_com_viomi_ffmpeg_cmd_tool_MediaPlayer_ ## FUNC_NAME \
    (JNIEnv *env, jobject thiz, ##__VA_ARGS__)\
...
#define PUSHER_FUNC(RETURN_TYPE, FUNC_NAME, ...) \
    JNIEXPORT RETURN_TYPE JNICALL java_com_viomi_ffmpeg_cmd_tool_Pusher_ ## FUNC_NAME \
    (JNIEnv *env, jobject thiz, ##__VA_ARGS__)\

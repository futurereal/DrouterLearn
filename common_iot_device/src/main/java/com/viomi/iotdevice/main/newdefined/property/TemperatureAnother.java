...
public class TemperatureAnother extends PropertyOperable<Vuint8> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.FridgechamberTemperature.toPropertyType();
    ...
    public TemperatureAnother() {
        ...
        super.setInstanceID(Miotspecv2Defined.CHAMBER_TEMPERATURE_PROPERTY_IID);
    }

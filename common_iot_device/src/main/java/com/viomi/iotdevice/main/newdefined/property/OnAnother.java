...
public class OnAnother extends PropertyOperable<Vbool> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.FridgechamberOn.toPropertyType();
    ...
    public OnAnother() {
        ...
        super.setInstanceID(Miotspecv2Defined.CHAMBER_ON_PROPERTY_IID);
    }

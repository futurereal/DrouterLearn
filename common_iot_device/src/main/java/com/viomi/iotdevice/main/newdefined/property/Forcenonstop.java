...
public class Forcenonstop extends PropertyOperable<Vbool> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Forcenonstop.toPropertyType();
    ...
    public Forcenonstop() {
        ...
        super.setInstanceID(Miotspecv2Defined.FORCENONSTOP_PROPERTY_IID);
    }

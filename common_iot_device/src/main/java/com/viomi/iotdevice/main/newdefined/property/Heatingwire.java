...
public class Heatingwire extends PropertyOperable<Vbool> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Heatingwire.toPropertyType();
    ...
    public Heatingwire() {
        ...
        super.setInstanceID(Miotspecv2Defined.HEATINGWIRE_PROPERTY_IID);
    }

...
public class Quickcooling extends PropertyOperable<Vbool> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Quickcooling.toPropertyType();
    ...
    public Quickcooling() {
        ...
        super.setInstanceID(Miotspecv2Defined.QUICKCOOLING_PROPERTY_IID);
    }

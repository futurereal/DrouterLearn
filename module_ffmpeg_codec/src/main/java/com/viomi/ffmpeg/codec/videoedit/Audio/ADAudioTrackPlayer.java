package com.viomi.ffmpeg.codec.videoedit.Audio;
...
import com.viomi.ffmpeg.codec.videoedit.Common.ByteUtil;
import com.viomi.ffmpeg.codec.videoedit.Common.DDlog;

import java.io.IOException;
import java.io.InputStream;

public class ADAudioTrackPlayer implements AudioPlayInterface{
    private static final String TAG = "ADAudioTrackPlayer";
    /** AudioTrack
    ...
    private void initAudioTrackByBuilder(int ch_layout,int sampleRate,int format) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Log.i(TAG, "initAudioTrackByBuilder: ");
        }
    }

package com.viomi.ffmpeg.codec.videoedit.ffmpegnative;

public class FFmpegEdit {
    static {
        System.loadLibrary("viomiMedia");
    }
    ...
    public native static void doCut(String src, String dst, int start, int du);

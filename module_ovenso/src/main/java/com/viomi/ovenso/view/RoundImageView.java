...
public class RoundImageView extends AppCompatImageView {
    ...
    public void setImageDrawable(Drawable drawable) {
        mResource = 0;
        mDrawable = fromDrawable(drawable, getResources());
    ...
    public void setImageBitmap(Bitmap bm) {
        mResource = 0;
        mDrawable = fromBitmap(bm, getResources());
        super.setImageDrawable(mDrawable);
        updateDrawable();
    }
    ...
    private Drawable resolveResource() {
        ...
        return fromDrawable(d, getResources());
    }
...
//*/
    ...
    public  Drawable fromDrawable(Drawable drawable, Resources r) {
        if (drawable != null) {
    ...
    public  SelectableRoundedCornerDrawable fromBitmap(Bitmap bitmap, Resources r) {
        if (bitmap != null) {
    ...
    class SelectableRoundedCornerDrawable extends Drawable {

...
object DataStoreUtils {
    ...
    fun <U> putSyncData(key: String, value: U) {
        Log.i(TAG, "putSyncData: $key : $value")
        when (value) {
    ...
    fun readBooleanFlow(key: String, default: Boolean = false): Flow<Boolean> =
        ApplicationUtils.getContext().dataStore.data.catch {
    ...
    fun readBooleanData(key: String, default: Boolean = false): Boolean {
        var value = false
        runBlocking {
            ApplicationUtils.getContext().dataStore.data.first {
    ...
    suspend fun saveBooleanData(key: String, value: Boolean) {
        ApplicationUtils.getContext().dataStore.edit { mutablePreferences ->
    ...
    suspend fun clear() {
        ApplicationUtils.getContext().dataStore.edit {
            it.clear()
        }
    }

...
public final class DownloadRequest implements Comparable<DownloadRequest> {
    ...
    private DownloadRequest(Builder builder) {
        uri = builder.uri;
        priority = Preconditions.checkNotNull(builder.priority, "priority == null");
        retryTime = new AtomicInteger(builder.retryTime);
        destinationDirectory =
                Preconditions.checkNotNull(builder.destinationDirectory, "destinationDirectory == null");
        destinationFilePath = builder.destinationFilePath;
        downloadCallback = Preconditions.checkNotNull(builder.downloadCallback, "downloadCallback == null");
    ...
    public static final class Builder {
        ...
        public Builder uri(Uri uri) {
            ...
            if (!Utils.HTTP.equals(scheme) && !Utils.HTTPS.equals(scheme)) {
        ...
        public Builder retryInterval(long interval, TimeUnit unit) {
            ...
            unit = Preconditions.checkNotNull(unit, "unit == null");

 ...
 */
package com.viomi.modulesetting.view.wheelview.graphics;
...
public class CommonDrawable extends WheelDrawable {
    ...
    private final GradientDrawable mTopShadow = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM,
            SHADOWS_COLORS);    // 顶部阴影

    private final GradientDrawable mBottomShadow = new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP,
            SHADOWS_COLORS);    // 底部阴影

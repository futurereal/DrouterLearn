 ...
 */
package com.viomi.modulesetting.view.wheelview.common;
...
public class WheelConstants {
     ...
     * 滚轮每一项的内边距
     */
    public static int WHEEL_ITEM_PADDING = 20;

    /**
     * 滚轮每一项的内部控件外边距
     */
    public static int WHEEL_ITEM_MARGIN = 20;
     ...
     * 滚轮item高度
     */
    public static int WHEEL_ITEM_HEIGHT = 45;

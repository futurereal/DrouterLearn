...
public class Bookstart extends EventOperable {

    public static final EventType TYPE = Miotspecv2Defined.Event.Bookstart.toEventType();
    ...
    public Bookstart() {
        ...
        super.setInstanceID(Miotspecv2Defined.BOOKSTART_EVENT_IID);
    }
}
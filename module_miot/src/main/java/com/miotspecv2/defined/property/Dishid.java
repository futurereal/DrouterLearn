...
public class Dishid extends PropertyOperable<Vuint8> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Dishid.toPropertyType();
    ...
    public Dishid() {
        ...
        super.setInstanceID(Miotspecv2Defined.DISHID_PROPERTY_IID);
    }

...
public class Recipestep extends PropertyOperable<Vuint32> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Recipestep.toPropertyType();
    ...
    public Recipestep() {
        ...
        super.setInstanceID(Miotspecv2Defined.RECIPESTEP_PROPERTY_IID);
    }

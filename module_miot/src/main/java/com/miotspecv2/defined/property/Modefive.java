...
public class Modefive extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Modefive.toPropertyType();
    ...
    public Modefive() {
        ...
        super.setInstanceID(Miotspecv2Defined.MODEFIVE_PROPERTY_IID);
    }

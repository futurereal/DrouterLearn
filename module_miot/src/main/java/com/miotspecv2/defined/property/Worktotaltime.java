...
public class Worktotaltime extends PropertyOperable<Vuint32> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Worktotaltime.toPropertyType();
    ...
    public Worktotaltime() {
        ...
        super.setInstanceID(Miotspecv2Defined.WORKTOTALTIME_PROPERTY_IID);
    }

...
public class Recipeeight extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Recipeeight.toPropertyType();
    ...
    public Recipeeight() {
        ...
        super.setInstanceID(Miotspecv2Defined.RECIPEEIGHT_PROPERTY_IID);
    }

...
public class Modethree extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Modethree.toPropertyType();
    ...
    public Modethree() {
        ...
        super.setInstanceID(Miotspecv2Defined.MODETHREE_PROPERTY_IID);
    }

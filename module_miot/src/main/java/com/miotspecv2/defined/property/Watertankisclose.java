...
public class Watertankisclose extends PropertyOperable<Vbool> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Watertankisclose.toPropertyType();
    ...
    public Watertankisclose() {
        ...
        super.setInstanceID(Miotspecv2Defined.WATERTANKISCLOSE_PROPERTY_IID);
    }

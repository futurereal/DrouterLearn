...
public class Recipefive extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Recipefive.toPropertyType();
    ...
    public Recipefive() {
        ...
        super.setInstanceID(Miotspecv2Defined.RECIPEFIVE_PROPERTY_IID);
    }

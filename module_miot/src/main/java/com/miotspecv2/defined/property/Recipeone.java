...
public class Recipeone extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Recipeone.toPropertyType();
    ...
    public Recipeone() {
        ...
        super.setInstanceID(Miotspecv2Defined.RECIPEONE_PROPERTY_IID);
    }

...
public class Tempz extends PropertyOperable<Vuint16> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Tempz.toPropertyType();
    ...
    public Tempz() {
        ...
        super.setInstanceID(Miotspecv2Defined.TEMPZ_PROPERTY_IID);
    }

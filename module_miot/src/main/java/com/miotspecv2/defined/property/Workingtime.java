...
public class Workingtime extends PropertyOperable<Vuint32> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Workingtime.toPropertyType();
    ...
    public Workingtime() {
        ...
        super.setInstanceID(Miotspecv2Defined.WORKINGTIME_PROPERTY_IID);
    }

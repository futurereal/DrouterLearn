...
public class Ovenhardwarever extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Ovenhardwarever.toPropertyType();
    ...
    public Ovenhardwarever() {
        ...
        super.setInstanceID(Miotspecv2Defined.OVENHARDWAREVER_PROPERTY_IID);
    }

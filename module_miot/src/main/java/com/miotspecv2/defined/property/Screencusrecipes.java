...
public class Screencusrecipes extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Screencusrecipes.toPropertyType();
    ...
    public Screencusrecipes() {
        ...
        super.setInstanceID(Miotspecv2Defined.SCREENCUSRECIPES_PROPERTY_IID);
    }

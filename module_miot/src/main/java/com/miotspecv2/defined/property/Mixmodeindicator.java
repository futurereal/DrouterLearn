...
public class Mixmodeindicator extends PropertyOperable<Vuint8> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Mixmodeindicator.toPropertyType();
    ...
    public Mixmodeindicator() {
        ...
        super.setInstanceID(Miotspecv2Defined.MIXMODEINDICATOR_PROPERTY_IID);
    }

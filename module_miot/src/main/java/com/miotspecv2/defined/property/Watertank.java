...
public class Watertank extends PropertyOperable<Vbool> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Watertank.toPropertyType();
    ...
    public Watertank() {
        ...
        super.setInstanceID(Miotspecv2Defined.WATERTANK_PROPERTY_IID);
    }

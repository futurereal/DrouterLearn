...
public class Modetwo extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Modetwo.toPropertyType();
    ...
    public Modetwo() {
        ...
        super.setInstanceID(Miotspecv2Defined.MODETWO_PROPERTY_IID);
    }

...
public class Microtime extends PropertyOperable<Vuint16> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Microtime.toPropertyType();
    ...
    public Microtime() {
        ...
        super.setInstanceID(Miotspecv2Defined.MICROTIME_PROPERTY_IID);
    }

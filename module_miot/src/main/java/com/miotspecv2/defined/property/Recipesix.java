...
public class Recipesix extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Recipesix.toPropertyType();
    ...
    public Recipesix() {
        ...
        super.setInstanceID(Miotspecv2Defined.RECIPESIX_PROPERTY_IID);
    }

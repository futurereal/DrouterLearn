...
public class Modeseven extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Modeseven.toPropertyType();
    ...
    public Modeseven() {
        ...
        super.setInstanceID(Miotspecv2Defined.MODESEVEN_PROPERTY_IID);
    }

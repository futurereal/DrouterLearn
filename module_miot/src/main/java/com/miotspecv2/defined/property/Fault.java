...
public class Fault extends PropertyOperable<Vuint32> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Fault.toPropertyType();
    ...
    public Fault() {
        ...
        super.setInstanceID(Miotspecv2Defined.FAULT_PROPERTY_IID);
    }

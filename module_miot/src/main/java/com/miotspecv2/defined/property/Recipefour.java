...
public class Recipefour extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Recipefour.toPropertyType();
    ...
    public Recipefour() {
        ...
        super.setInstanceID(Miotspecv2Defined.RECIPEFOUR_PROPERTY_IID);
    }

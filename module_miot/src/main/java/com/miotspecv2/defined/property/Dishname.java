...
public class Dishname extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Dishname.toPropertyType();
    ...
    public Dishname() {
        ...
        super.setInstanceID(Miotspecv2Defined.DISHNAME_PROPERTY_IID);
    }

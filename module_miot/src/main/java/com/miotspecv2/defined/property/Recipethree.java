...
public class Recipethree extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Recipethree.toPropertyType();
    ...
    public Recipethree() {
        ...
        super.setInstanceID(Miotspecv2Defined.RECIPETHREE_PROPERTY_IID);
    }

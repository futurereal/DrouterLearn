...
public class Timek extends PropertyOperable<Vuint32> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Timek.toPropertyType();
    ...
    public Timek() {
        ...
        super.setInstanceID(Miotspecv2Defined.TIMEK_PROPERTY_IID);
    }

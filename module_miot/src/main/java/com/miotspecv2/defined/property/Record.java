...
public class Record extends PropertyOperable<Vuint8> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Record.toPropertyType();
    ...
    public Record() {
        ...
        super.setInstanceID(Miotspecv2Defined.RECORD_PROPERTY_IID);
    }

...
public class Ovenlight extends PropertyOperable<Vbool> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Ovenlight.toPropertyType();
    ...
    public Ovenlight() {
        ...
        super.setInstanceID(Miotspecv2Defined.OVENLIGHT_PROPERTY_IID);
    }

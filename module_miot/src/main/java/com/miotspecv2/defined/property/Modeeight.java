...
public class Modeeight extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Modeeight.toPropertyType();
    ...
    public Modeeight() {
        ...
        super.setInstanceID(Miotspecv2Defined.MODEEIGHT_PROPERTY_IID);
    }

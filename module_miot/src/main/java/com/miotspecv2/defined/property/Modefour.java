...
public class Modefour extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Modefour.toPropertyType();
    ...
    public Modefour() {
        ...
        super.setInstanceID(Miotspecv2Defined.MODEFOUR_PROPERTY_IID);
    }

...
public class Modename extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Modename.toPropertyType();
    ...
    public Modename() {
        ...
        super.setInstanceID(Miotspecv2Defined.MODENAME_PROPERTY_IID);
    }

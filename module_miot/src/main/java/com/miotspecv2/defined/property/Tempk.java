...
public class Tempk extends PropertyOperable<Vuint16> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Tempk.toPropertyType();
    ...
    public Tempk() {
        ...
        super.setInstanceID(Miotspecv2Defined.TEMPK_PROPERTY_IID);
    }

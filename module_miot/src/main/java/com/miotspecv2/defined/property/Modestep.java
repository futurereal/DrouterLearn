...
public class Modestep extends PropertyOperable<Vuint16> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Modestep.toPropertyType();
    ...
    public Modestep() {
        ...
        super.setInstanceID(Miotspecv2Defined.MODESTEP_PROPERTY_IID);
    }

...
public class Recipetwo extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = Miotspecv2Defined.Property.Recipetwo.toPropertyType();
    ...
    public Recipetwo() {
        ...
        super.setInstanceID(Miotspecv2Defined.RECIPETWO_PROPERTY_IID);
    }

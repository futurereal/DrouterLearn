...
public class Clearfault extends ActionOperable {

    public static final ActionType TYPE = Miotspecv2Defined.Action.Clearfault.toActionType();
    ...
    public Clearfault() {
        ...
        super.setInstanceID(Miotspecv2Defined.CLEARFAULT_ACTION_IID);
    }
}